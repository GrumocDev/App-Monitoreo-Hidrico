...
SQLALCHEMY_DATABASE_URI = 'postgresql://udc_user:S3cret@udc_postgres:5432/udc_db_develop'
SQLALCHEMY_TRACK_MODIFICATIONS = False
SHOW_SQLALCHEMY_LOG_MESSAGES = False

ERROR_404_HELP = False

MQTT_BROKER_URL = 'hpc.unicartagena.edu.co'  # use the free broker from HIVEMQ
...
MQTT_CLIENT_ID = 'production_client_25698'
